...
ulimit -n 100000
(taskset -c 1 dpbench/bin/h1load -e -ll -P -t 1 -s 30 -d 120 -R 1000 -c 12 http://server:8000/ > results/ref.data) &

taskset -c 0-1 dpbench/bin/h1load -e -ll -P -t 1 -s 30 -d 120 -c 100 http://proxy:8000/ | tee results/client.data
